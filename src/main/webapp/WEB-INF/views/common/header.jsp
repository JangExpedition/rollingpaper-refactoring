...
<nav class="navbar navbar-expand-lg navbar-light bg-light w-100">
  <a class="navbar-brand" href="${ pageContext.request.contextPath }/member/memberList.do">Rollingpaper</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="${ pageContext.request.contextPath }/member/logout.do">Logout<span class="sr-only">(current)</span></a>
      </li>
    </ul>
